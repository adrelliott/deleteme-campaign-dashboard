<div class="form-group col-lg-12 col-md-12 col-sm-12  col-xs-12">
	...
	<input type="text" class="form-control input-lg contact-search4" name="" id="" placeholder="Start typing the surname..."  value="<?= $p->other_contact_full_name(); ?>">
</div>
...
<h1>this is the form_relationship</h1>
