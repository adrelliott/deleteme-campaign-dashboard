...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <a class="btn btn-primary pull-right open-modal" href="#" modal-source="<?= site_url('relationships/create'); ?>" data-alert_class="relationship" data-contact_id="<?= $contact->id();?>"  ><i class="fa fa-plus"></i> Create New Relationship</a>
  </div>
</div>