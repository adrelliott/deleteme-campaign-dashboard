            ...
            <li class="list-group-item hide">
                <div class="row">
                    <div class="form-group col-lg-1 col-md-1 col-sm-2 col-xs-12">
                        ...
                        <?= form_dropdown('operator[]', array('or' => 'or', 'and' => 'and', 'not' => 'but not'), 'or', 'class="form-control input-sm"'); ?>
                    </div>
                    ...
                    <div class="form-group col-lg-3 col-md-3 offset-md-2 col-sm-6 col-xs-12">
