        ...
        <ul class="list-group " id="basic_search">
          ...
          <li class="list-group-item">
              ...
              <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <?= form_dropdown('product_id[]', to_dropdown($p->products(), 'product_name', 'Choose a Product'), '', 'class="form-control"'); ?>
              </div>

              <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <label class="sr-only" for="season[]">Choose a Season</label>
                <?= form_dropdown('season[]', config('seasons', 'dropdowns'), '', 'class="form-control"'); ?>
              </div>

              <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                <label class="sr-only" for="date_type[]">Choose a date search type</label>
                <?= form_dropdown('date_type[]', array('' => 'I don\'t care when they ordered', 'before' => 'Ordered before', 'on' => 'Ordered on', 'after' => 'Ordered After'), '', 'class="form-control"'); ?>
              </div>
         ...
         <li class="list-group-item hide">
            <div class="form-group col-lg-1 col-md-2 col-sm-2 col-xs-12">
                ...
                <?= form_dropdown('operator[]', array('or' => 'or', 'and' => 'and', 'not' => 'but not'), 'or', 'class="form-control"'); ?>
              </div>
              ...
              <div class="form-group col-lg-3 col-md-2 col-sm-5 col-xs-12">
                <label class="sr-only" for="season[]">Last name</label>
                <?= form_dropdown('season[]', config('seasons', 'dropdowns'), '', 'class="form-control"'); ?>
              </div>

              <div class="form-group col-lg-2 col-md-2 col-sm-6 col-xs-12">
                <label class="sr-only" for="date_type[]">Mobile Number</label>
                <?= form_dropdown('date_type[]', array('' => 'I don\'t care when they ordered', 'before' => 'Ordered before', 'on' => 'Ordered on', 'after' => 'Ordered After'), '', 'class="form-control"'); ?>
              </div>
