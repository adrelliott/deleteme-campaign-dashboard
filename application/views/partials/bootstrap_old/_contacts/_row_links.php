...
<div class="row">
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <a class="btn btn-primary pull-right open-modal" href="#" data-source="<?= site_url('relationships/create/' . $contact->id() ); ?>"  data-column="2" ><i class="fa fa-plus"></i> Create New Relationship</a>
  </div>
</div>
<code>To do:
