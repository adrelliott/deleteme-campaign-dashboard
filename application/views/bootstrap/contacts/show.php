    ...
    <div class="tabbable">
      ...
      <div class="tab-content">
        <div class="tab-pane active" id="overview"> <br/>
          <p class="lead">More of
            <?= $contact->get_name_owned(); ?>
            data under each blue tab</p>
        ...
        <div class="tab-pane" id="indepth"> <br/>
          <p class="lead">All of
            <?= $contact->get_name_owned(); ?>
            secrets...</p>
        ...
        <div class="tab-pane" id="optins"> <br/>
          <p class="lead">Manage
            <?= $contact->get_name_owned(); ?>
        ...
        <div class="tab-pane" id="notes"> <br/>
          <p class="lead">All the stuff we've said about
        ...
        <div class="tab-pane" id="relationships"> <br/>
          <p class="lead">Who does
            <?= $contact->get_first_name(); ?>
            know?</p>
        ...
        <button class="btn btn-danger btn-xs pull-left" onclick="return deletechecked();">Delete
        <?= $contact->get_first_name()?>
        </button>
        </a> </div>
    </div>
...
<br>
<p class="lead">"Todo's for
  <?= $contact->get_first_name(); ?>
</p>
<div id="message-task" style="visibility: hidden" class="alert-info"></div>
<table class="table DataTable" table-id="dashboard-table" id="dashboard-table" data-source="<?php echo site_url('ajax/contact_actions/get_table/id/action_type/action_title/completed'); ?>" contact-id="<?php echo $contact->id() ?>" data-link="<?php echo site_url() . 'contacts/show/'; ?>" html-source="<?php echo site_url('contact_actions/show' ); ?>" table-type="modal" link-class="test test2" sScrollY="500">
  <thead>
    <tr>
      <th>Id</th>
      <th>Action Type</th>
...
<div class="tab-pane" id="orders"> <br>
  <p class="lead">See what
    <?= $contact->get_first_name(); ?>
    has been buying</p>
  <a class="btn btn-lg btn-primary pull-right " href="#contactaction-modal" data-toggle="modal">Create New Order &raquo;</a> </div>
<div class="tab-pane" id="roles"> <br>
  <p class="lead">"Remember when "
    <?= $contact->get_first_name(); ?>
    did that thing..?</p>
</div>
<div class="tab-pane" id="tags"> <br>
  <p class="lead">"Tags's for
    <?= $contact->get_first_name(); ?>
  </p>
  ...
  <a class="btn btn-primary pull-right" data-target="#contactaction-modal" href="" data-toggle="modal">Create New Tag &raquo;</a> </div>
</div>
</div>
<!-- End of pills -->
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Action for
          <?= $contact->get_first_name(); ?>
        </h4>
      </div>
...
<div id="delete-dialog" title="Remove User">
  ...
  <!--	<button type="button" class="Delete" id="Delete" data-dismiss="modal" aria-hidden="true">Delete</button>
	<button type="button" class="Cancel" id="Cancel" data-dismiss="modal" aria-hidden="true">Cancel</button>-->
</div>
<? dump($contact); ?>
