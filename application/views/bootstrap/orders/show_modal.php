						...
						<?if (count($p->order_items())) : ?>
							<? foreach ($p->order_items() as $row => $array) : ?>
								<tr id="row_<?= $row; ?>">
									<td>
									<label class="sr-only" for="product_name">Product Name</label>
									<input type="text" class="form-control input-sm " name="product_name[]" data-name="product_list" data-limit="4" onselected="id=product_id" idfield="product_id_row1"  id="product_name[]"  value="<?= $array['product_name']; ?>">
								</td>
								<td>
									<label class="sr-only" for="product_price">Product Price</label>
									<input type="text" class="form-control input-sm" name="product_price[]" id="product_price[]"  value="<?= $array['product_price']; ?>">
								</td>
								<td>
									<label class="sr-only" for="qty">Quantity</label>
									<input type="text" class="form-control input-sm" name="qty[]" id="qty[]"  value="<?= $array['quantity']; ?>">
								</td>
								<td>
									<label class="sr-only" for="line_total">Line Total</label>
									<input type="text" id="product_id_row1" class="form-control input-sm" name="line_total[]" id="line_total[]"  value="<?= $array['product_id']; ?>">
								</td>
								</tr>
							<? endforeach; ?>
						<? endif; ?>
