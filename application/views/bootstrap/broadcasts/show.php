				...
				<div class="well"><!-- Well -->
					<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><!-- /col-->
						...
						<div class="form-group col-lg-12 col-md-12 col-sm-12  col-xs-12">
							...
							<textarea class="form-control input-lg wysihtml5" rows="20" placeholder="Hi. Get to Asda as soon as you can. No time to explain." name="email_body" id="email_body"><?= $p->email_body(); ?></textarea>
						</div>
