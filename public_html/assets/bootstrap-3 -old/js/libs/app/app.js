...
(function($) {
    ...
    function createDataTable( selector )
    {
        ...
        var o = {
            oLanguage: {
                "sEmptyTable": "<p class='lead'>This table is emptier than your hamster's momma's bed!</p><p><i><small>Actually, we never actually checked if your hamster's mother is going through any kind of trial separation, bereavement or divorce. No offence was meant. It was just something we heard some men say at the local pub and we thought it would be cool to copy them. <br/>Really sorry if we upset you or any of your rodents.</small></i></p>"
            },
            aoColumnDefs: [],
            iDisplayLength: 5,
            bDestroy: true,
